package com.clickhouse.alnscodingexercise.domains.iamplatform.authz.web.controllers.mvc;
...
public class RoleHierarchyPageController {

    @GetMapping("/" + AppConstants.DEFAULT_PAGES_IAM_AUTHZ_PREFIX_PATH + "/roleHierarchy")
