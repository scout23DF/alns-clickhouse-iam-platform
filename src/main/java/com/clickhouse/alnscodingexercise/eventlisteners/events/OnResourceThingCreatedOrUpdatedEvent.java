...
public class OnResourceThingCreatedOrUpdatedEvent extends ApplicationEvent {
    ...
    private final List<ProtectedObjectAclDTO> accessControlList;

    public OnResourceThingCreatedOrUpdatedEvent(ResourceThingDTO resourceThingDTO, List<ProtectedObjectAclDTO> accessControlList) {
